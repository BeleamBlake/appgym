...
object SingletonData {
    ...
    init{
        ...
        arrayList_mensajes.add(3, "Nombre invalido")
        arrayList_mensajes.add(4, "El numero de celular invalido")
        arrayList_mensajes.add(5, "Apellido invalido")
        ...
        arrayList_mensajes.add(9, "Miembro registrado con exito")
        arrayList_mensajes.add(10, "No se registro en la base de datos")



        arrayList_validaciones = ArrayList<String>()
        arrayList_validaciones.add(0, "^[A-Za-z+_.-]+@[A-Za-z0-9.-]+$") // correo electronico
        arrayList_validaciones.add(1, "[0-9]{10}")// validador de contraseña y numero de celular
